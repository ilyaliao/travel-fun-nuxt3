            ...
            <div role="radiogroup" aria-label="方案選擇" class="flex flex-col gap-2.5">
              ...
              >
                ...
                <div class="flex-1 min-w-0">
                  ...
                  <div class="text-xs text-cc-grey-66 mt-1 line-clamp-2" v-html="plan.content" />
                  <div class="mt-2 flex gap-2 items-baseline">
                    ...
                    <span
                      ...
                      class="text-xs text-cc-grey-66 line-through tabular-nums"
                    >
                  ...
                  >
                    ...
                    <span
                      ...
                      class="text-xs text-green-700 px-2 py-0.5 rounded bg-green-50"
                    >
                      ✓ {{ plan.cancellationPolicy }}
                    </span>
                  </div>
